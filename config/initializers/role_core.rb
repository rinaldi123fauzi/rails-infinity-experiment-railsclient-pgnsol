...
RoleCore.permission_set_class.draw do
  ...
  group :warehouse, model_name: 'Warehouse' do
    permission :manage
  end
  ...
  group :item_group, model_name: 'item_group' do
    permission :manage
  end

  group :measurement, model_name: 'Measurement' do
    permission :manage
  end
  ...
  permission  :approval_staff_accounting
