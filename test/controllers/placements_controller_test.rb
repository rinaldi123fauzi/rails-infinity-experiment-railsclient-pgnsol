...
class PlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placement" do
    assert_difference('Placement.count') do
      post placements_url, params: { placement: { lokasi_penempatan: @placement.lokasi_penempatan, warehouses_id: @placement.warehouses_id } }
    end
  ...
  test "should update placement" do
    patch placement_url(@placement), params: { placement: { lokasi_penempatan: @placement.lokasi_penempatan, warehouses_id: @placement.warehouses_id } }
