...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { alamat_gudang: @warehouse.alamat_gudang, nama_gudang: @warehouse.nama_gudang } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { alamat_gudang: @warehouse.alamat_gudang, nama_gudang: @warehouse.nama_gudang } }
